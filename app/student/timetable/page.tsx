...
export default function Timetable() {
  ...
  return (
    <div className="p-4 md:p-8 w-full">
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-indigo-700 dark:text-indigo-300 mb-2 tracking-tight">Class Timetable</h1>
        <p className="text-gray-600 dark:text-gray-400">Your weekly class schedule</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {daysOfWeek.map((day) => (
          <div key={day} className="transition-transform hover:scale-[1.02]">
            <Card className="h-fit border border-indigo-100 dark:border-indigo-800 shadow-md rounded-xl">
              <CardHeader className="bg-indigo-50 dark:bg-indigo-900 rounded-t-xl">
                <CardTitle className="flex items-center text-indigo-700 dark:text-indigo-300">
                  <Calendar className="h-5 w-5 mr-2" />
                  {day}
                </CardTitle>
                <CardDescription className="text-indigo-500 dark:text-indigo-200">
              ...
              <CardContent>
                {groupedTimetable[day].length > 0 ? (
                  ...
                  <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                    <Clock className="h-8 w-8 mx-auto mb-2 text-gray-300 dark:text-gray-700" />
